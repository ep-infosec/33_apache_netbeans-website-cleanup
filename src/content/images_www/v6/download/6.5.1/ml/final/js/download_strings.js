...
var NOTE_JAVAFX_OLD = "<br>JavaFX is currently bundled with NetBeans IDE 6.5";
...
var NOTE_JAVAFX  = "<br>JavaFX is available only in English and only on Windows and Mac OS X.";
